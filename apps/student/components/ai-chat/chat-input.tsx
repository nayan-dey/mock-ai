      ...
      <div className="mx-auto max-w-2xl">
        <div className="flex items-end gap-2 rounded-3xl bg-white dark:bg-stone-800 p-2 shadow-sm">
          <input
            ...
            placeholder="Message MockTest AI..."
            className="flex-1 bg-transparent px-3 py-2 text-base text-stone-700 dark:text-stone-200 placeholder:text-stone-400 focus:outline-none"
            disabled={isLoading}
          />
          {isLoading ? (
            <button
            ...
            <button
              type="submit"
              disabled={!input.trim()}
              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-stone-800 dark:bg-stone-200 transition-all disabled:opacity-30"
            >
